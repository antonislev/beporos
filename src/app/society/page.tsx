  ...
  return (
    <section className="px-6 md:px-10 py-24 max-w-[1200px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {societyPosts[0] && (
          <div className="md:col-span-2 bg-[var(--text)] text-[var(--text-inv)] p-10 md:p-16 flex flex-col justify-end min-h-[400px]">
            <span className="font-display text-[9px] tracking-[3px] text-[var(--accent)] uppercase mb-4">
              {societyPosts[0].tag}
            </span>
            <h2 className="font-display text-[clamp(22px,3vw,32px)] font-bold tracking-[3px] uppercase mb-4">
              {societyPosts[0].title}
            </h2>
            <p className="text-[var(--muted)] max-w-[600px] leading-relaxed font-light">
        ...
        {societyPosts.slice(1).map((post) => (
          <div
            key={post.id}
            className="bg-[var(--bg-alt)] p-8 md:p-10 flex flex-col justify-end min-h-[260px]"
          >
