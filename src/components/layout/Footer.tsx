...
export default function Footer() {
  return (
    <footer className="border-t border-[var(--border)] px-6 md:px-10 py-16">
      <div className="max-w-[1200px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          {/* Links */}
          <div>
            <h4 className="font-display text-[10px] tracking-[3px] text-[var(--muted)] mb-4">
              MENU
            </h4>
        ...
        <div className="border-t border-[var(--border)] pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <span className="font-display text-[9px] tracking-[2px] text-[var(--muted)]">
            © 2026 BEPOROS
          </span>
          <div className="flex gap-6">
            <Link
              href="/shipping"
              className="font-display text-[9px] tracking-[2px] text-[var(--muted)] hover:text-[var(--text)] transition-colors"
            >
              SHIPPING
            </Link>
            <Link
